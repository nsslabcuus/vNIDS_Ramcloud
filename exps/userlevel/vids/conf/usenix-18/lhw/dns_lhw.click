...
FromDevice(enp0s3, OUTBOUND 1) -> IPclasses
IPclasses[0] -> SetTimestamp -> CheckIPHeader(14) -> IPReassembler() -> GeneveEncap(opt_len 4) -> tcp_or_udp
IPclasses[1] -> Discard
...
tcp_classifier[0] -> [0] mltstp_lw_detector [0] -> Print(ok) -> HTTPAnalyzer() -> Print(ok) -> Discard

#ifndef CLICK_VIDS_PERFLOWANALYSISLOCAL_HH
#define CLICK_VIDS_PERFLOWANALYSISLOCAL_HH
...
class PerFlowAnalysisLocal : public Element {

public:
    PerFlowAnalysisLocal();
    ~PerFlowAnalysisLocal();

    const char* class_name() const { return "PerFlowAnalysisLocal"; }

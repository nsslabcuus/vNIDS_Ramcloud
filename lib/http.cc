...
HTTP_Conn::HTTP_Conn(HttpHeaders *headers)
{
...
bool HTTP_PDU::ParseBuffer(flow_buffer_t t_flow_buffer, ContextHTTP *t_context)
{
	...
	case 0:
		...
		break;
	default:
		throw binpac::ExceptionInvalidCaseIndex("HTTP_PDU", val_case_index());
		break;
	}
	if (t_val_parsing_complete)
	{
		// Evaluate 'let' and 'withinput' fields
		process_message_ = t_context->flow()->porcess_http_message_done(this);
	}
...
bool HTTP_RequestLine::ParseBuffer(flow_buffer_t t_flow_buffer, ContextHTTP *t_context)
{
	...
	{
		throw binpac::ExceptionStringMismatch("./http-protocol.pac:73", "[^()<>@,;:\\\"/\\[\\]?={} \\t]+", string((const char *)(t_begin_of_data), (const char *)t_end_of_data).c_str());
	}
	int t_method__size;
	t_method__size = t_method_string_length;
	// check for negative sizes
	if (t_method_string_length < 0)
		throw binpac::ExceptionInvalidStringLength("./http-protocol.pac:73", t_method_string_length);
	...
	{
		throw binpac::ExceptionStringMismatch("./http-protocol.pac:74", "[ \\t]*", string((const char *)(t_dataptr_after_method), (const char *)t_end_of_data).c_str());
	}
	...
	{
		throw binpac::ExceptionStringMismatch("./http-protocol.pac:75", "[/[:alnum:][:punct:]]+", string((const char *)(t_dataptr_after_anonymous_field_004), (const char *)t_end_of_data).c_str());
	}
	int t_uri__size;
	t_uri__size = t_uri_string_length;
	// check for negative sizes
	if (t_uri_string_length < 0)
		throw binpac::ExceptionInvalidStringLength("./http-protocol.pac:75", t_uri_string_length);
	...
	{
		throw binpac::ExceptionStringMismatch("./http-protocol.pac:76", "[ \\t]*", string((const char *)(t_dataptr_after_uri), (const char *)t_end_of_data).c_str());
	}
	...
	// Evaluate 'let' and 'withinput' fields
	UNUSED(t_version__size);

	t_val_parsing_complete = true;
	if (t_val_parsing_complete)
	{
		// Evaluate 'let' and 'withinput' fields
		process_request_ = t_context->flow()->porcess_http_requestline(method(), uri(), version());
	}
	buffering_state_ = 0;
	return t_val_parsing_complete;
}
...
bool HTTP_ReplyLine::ParseBuffer(flow_buffer_t t_flow_buffer, ContextHTTP *t_context)
{
	bool t_val_parsing_complete;
	t_val_parsing_complete = false;
	const_byteptr t_begin_of_data = t_flow_buffer->begin();
	...
	{
		throw binpac::ExceptionStringMismatch("./http-protocol.pac:93", "[ \\t]*", string((const char *)(t_dataptr_after_version), (const char *)t_end_of_data).c_str());
	}
	...
	{
		throw binpac::ExceptionStringMismatch("./http-protocol.pac:95", "[ \\t]*", string((const char *)(t_dataptr_after_status), (const char *)t_end_of_data).c_str());
	}
	...
	UNUSED(t_reason__size);
	
	// check for negative sizes
	if (t_reason_string_length < 0)
		throw binpac::ExceptionInvalidStringLength("./http-protocol.pac:96", t_reason_string_length);
	...
	{
		// Evaluate 'let' and 'withinput' fields
		process_reply_ = t_context->flow()->porcess_http_replyline(version(), status()->stat_num(), reason());
	}
	buffering_state_ = 0;
	return t_val_parsing_complete;
}
...
int HTTP_Status::Parse(const_byteptr const t_begin_of_data, const_byteptr const t_end_of_data)
{
	...
	{
		throw binpac::ExceptionStringMismatch("./http-protocol.pac:101", "[0-9]{3}", string((const char *)(t_begin_of_data), (const char *)t_end_of_data).c_str());
	}
	int t_stat_str__size;
	t_stat_str__size = t_stat_str_string_length;
	// check for negative sizes
	if (t_stat_str_string_length < 0)
		throw binpac::ExceptionInvalidStringLength("./http-protocol.pac:101", t_stat_str_string_length);
...
int HTTP_Version::Parse(const_byteptr const t_begin_of_data, const_byteptr const t_end_of_data)
{
	...
	if (t_begin_of_data + (5) > t_end_of_data || t_begin_of_data + (5) < t_begin_of_data)
	{
		...
		throw binpac::ExceptionOutOfBound("HTTP_Version:anonymous_field_009",
										  (0) + (5),
										  (t_end_of_data) - (t_begin_of_data));
	}
	...
	{
		throw binpac::ExceptionStringMismatch("./http-protocol.pac:107", "HTTP/", string((const char *)(t_begin_of_data), (const char *)t_end_of_data).c_str());
	}
	// Evaluate 'let' and 'withinput' fields
	...
	{
		throw binpac::ExceptionStringMismatch("./http-protocol.pac:108", "[0-9]+\\.[0-9]+", string((const char *)((t_begin_of_data + 5)), (const char *)t_end_of_data).c_str());
	}
	int t_vers_str__size;
	t_vers_str__size = t_vers_str_string_length;
	// check for negative sizes
	if (t_vers_str_string_length < 0)
		throw binpac::ExceptionInvalidStringLength("./http-protocol.pac:108", t_vers_str_string_length);
...
bool HTTP_Headers::ParseBuffer(flow_buffer_t t_flow_buffer, ContextHTTP *t_context)
{
	bool t_val_parsing_complete;
	t_val_parsing_complete = false;
	if (val__elem__it_ < 0)
...
end_of_val:;
	...
	{
		// Evaluate 'let' and 'withinput' fields
		process_end_of_headers_ = t_context->flow()->porcess_http_headers(this);
	}
	BINPAC_ASSERT(t_val_parsing_complete);
	return t_val_parsing_complete;
...
bool HTTP_Header::ParseBuffer(flow_buffer_t t_flow_buffer, ContextHTTP *t_context)
{
	bool t_val_parsing_complete;
	t_val_parsing_complete = false;
	const_byteptr t_begin_of_data = t_flow_buffer->begin();
	...
	{
		throw binpac::ExceptionStringMismatch("./http-protocol.pac:132", "([^: \\t]+:)", string((const char *)(t_begin_of_data), (const char *)t_end_of_data).c_str());
	}
	int t_name__size;
	t_name__size = t_name_string_length;
	// check for negative sizes
	if (t_name_string_length < 0)
		throw binpac::ExceptionInvalidStringLength("./http-protocol.pac:132", t_name_string_length);
	...
	{
		throw binpac::ExceptionStringMismatch("./http-protocol.pac:133", "[ \\t]*", string((const char *)(t_dataptr_after_name), (const char *)t_end_of_data).c_str());
	}
	...
	UNUSED(t_value__size);
	// check for negative sizes
	if (t_value_string_length < 0)
		throw binpac::ExceptionInvalidStringLength("./http-protocol.pac:134", t_value_string_length);
	...
	{
		// Evaluate 'let' and 'withinput' fields
		process_header_ = t_context->flow()->porcess_http_header(name_, value_);
	}
	buffering_state_ = 0;
	return t_val_parsing_complete;
}
...
bool MIME_Line::ParseBuffer(flow_buffer_t t_flow_buffer)
{
	...
	if (t_line_string_length < 0)
		throw binpac::ExceptionInvalidStringLength("./http-protocol.pac:138", t_line_string_length);
...
bool HTTP_Body::ParseBuffer(flow_buffer_t t_flow_buffer, ContextHTTP *t_context)
{
				...
				case 2:
					...
					if (t_flow_buffer->ready())
					{
						...
						if (t_body_string_length < 0)
							throw binpac::ExceptionInvalidStringLength("./http-protocol.pac:148", t_body_string_length);
	...
	case 2:
		// Parse "chunks"
		{
			...
			t_chunks_parsing_complete = chunks_->ParseBuffer(t_flow_buffer, t_context);
...
bool HTTP_UnknownBody::ParseBuffer(flow_buffer_t t_flow_buffer)
{
	...
	case 0:
		// Parse "rest"
		{
			...
			while (!t_rest_parsing_complete && t_flow_buffer->ready())
			{
				...
				if (t_rest_string_length < 0)
					throw binpac::ExceptionInvalidStringLength("./http-protocol.pac:157", t_rest_string_length);
		...
		break;
	default:
		throw binpac::ExceptionInvalidCaseIndex("HTTP_UnknownBody", val_case_index());
		break;
	}
	if (t_val_parsing_complete)
	{
...
bool HTTP_Chunks::ParseBuffer(flow_buffer_t t_flow_buffer, ContextHTTP *t_context)
{
	bool t_val_parsing_complete;
	t_val_parsing_complete = false;
	switch (parsing_state_)
	...
	case 1:
	{
		...
		while (!t_length_line_parsing_complete && t_flow_buffer->ready())
		{
			...
			if (t_length_line_string_length < 0)
				throw binpac::ExceptionInvalidStringLength("./http-protocol.pac:166", t_length_line_string_length);
			...
			case 2:
				...
				if (t_flow_buffer->ready())
				{
					...
					if (t_data_string_length < 0)
						throw binpac::ExceptionInvalidStringLength("./http-protocol.pac:167", t_data_string_length);
			...
			// Parse "crlf"
			{
				...
				while (!t_crlf_parsing_complete && t_flow_buffer->ready())
				{
					...
					if (t_crlf_string_length < 0)
						throw binpac::ExceptionInvalidStringLength("./http-protocol.pac:170", t_crlf_string_length);
	...
	try
	{
			   ...
			   (!flow_buffer_->have_pending_request() || flow_buffer_->ready()))
		{
			if (!dataunit_)
			{
				...
				context_ = new ContextHTTP(connection(), this, flow_buffer());
			}
...
bool HTTP_Flow::porcess_http_requestline(const_bytestring const &method, const_bytestring const &uri, HTTP_Version *vers)
{
	UNUSED(method);
	UNUSED(uri);
	UNUSED(vers);
...
bool HTTP_Flow::porcess_http_replyline(HTTP_Version *vers, int code, const_bytestring const &reason)
{
	UNUSED(vers);
	UNUSED(code);
	UNUSED(reason);
...
bytestring HTTP_Flow::extract_boundary(const_bytestring const &value)
{
...
bool HTTP_Flow::porcess_http_header(const_bytestring const &name_colon, const_bytestring const &value)
{

	const_bytestring name(name_colon.begin(),
						  name_colon.length() > 0 ? name_colon.end() - 1 : name_colon.end());
	...
	String name_val = String((const unsigned char *)name.begin(), name.length());
	String value_val = String((const unsigned char *)value.begin(), value.length());
	connection()->headers()->insert(name_val, value_val);

	return true;
}

bool HTTP_Flow::porcess_http_headers(HTTP_Headers *headers)
{
	UNUSED(headers);
...
bool HTTP_Flow::porcess_http_message_done(HTTP_PDU *pdu)
{
	UNUSED(pdu);
	return true;
}
...
#endif
EXPORT_ELEMENT(http)
ELEMENT_LIBS('pkg-config --libs libpcre')

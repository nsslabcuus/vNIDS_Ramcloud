#ifndef CLICKNET_HTTP_H
#define CLICKNET_HTTP_H
...
int http_parse(const unsigned char* data,
        const unsigned char* end, HttpHeaders *headers);

#define DEBUG_HTTP_BINPAC
	...
	HTTP_Request * request() const
		...
		switch ( val_case_index() )
			...
			case 1:
				break;  // OK
			default:
				throw binpac::ExceptionInvalidCase("./http-protocol.pac:27:request", val_case_index(), "true");
				break;
			}
		return request_;
		}
	HTTP_Reply * reply() const
		...
		switch ( val_case_index() )
			...
			case 0:
				break;  // OK
			default:
				throw binpac::ExceptionInvalidCase("./http-protocol.pac:28:reply", val_case_index(), "false");
				break;
			}
		return reply_;
		}
	bool is_orig() const { return is_orig_; }
	bool process_message() const { return process_message_; }
...
public:
	...
	bool process_reply() const { return process_reply_; }
...
public:
	...
	bool process_end_of_headers() const { return process_end_of_headers_; }
	...
	HTTP_Chunks * chunks() const
		...
		switch ( val_case_index() )
			...
			case 2:
				break;  // OK
			default:
				throw binpac::ExceptionInvalidCase("./http-protocol.pac:150:chunks", val_case_index(), "CHUNKED");
				break;
			}
		return chunks_;
		}
	MIME_Lines * multipart() const
		...
		switch ( val_case_index() )
			...
			case 3:
				break;  // OK
			default:
				throw binpac::ExceptionInvalidCase("./http-protocol.pac:151:multipart", val_case_index(), "MULTIPART");
				break;
			}
		return multipart_;
		}
...
public:
	...
	bool porcess_http_requestline(const_bytestring const & method, const_bytestring const & uri, HTTP_Version * vers);
	bool porcess_http_replyline(HTTP_Version * vers, int code, const_bytestring const & reason);
	bytestring extract_boundary(const_bytestring const & value);
	bool is_end_of_multipart(const_bytestring const & line);
	bool porcess_http_header(const_bytestring const & name_colon, const_bytestring const & value);
	bool porcess_http_headers(HTTP_Headers * headers);
	bool porcess_http_message_done(HTTP_PDU * pdu);
